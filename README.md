...
-->
# Python SDK for IBM Cloud Code Engine 3.0.0
...
--- | ---
[IBM Cloud Code Engine V2](https://cloud.ibm.com/apidocs/codeengine/codeengine-v3.0.0) | CodeEngineV2
[IBM Cloud Code Engine V1](https://cloud.ibm.com/apidocs/codeengine/codeengine-v3.0.0) | IbmCloudCodeEngineV1
...
```bash
pip install --upgrade "ibm_code_engine_sdk>=3.0.0"
```

or

```bash
easy_install --upgrade "ibm_code_engine_sdk>=3.0.0"
```
